...
When asking clarifying questions, the AI _must_ format them as a numbered list. This list should support nested sub-questions using dot notation (e-g., 1, 2, 2.1, 2.2, 3).
...
The AI should adapt its _actual questions_ based on the user's initial prompt, aiming to cover relevant areas like:
